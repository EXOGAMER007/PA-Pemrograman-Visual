...
Module Module1
    ...
    Sub koneksi()
        Try
            Dim STR As String =
            "server=localhost;userid=root;password=;database=PeminjamanPT5"
...
Public Class Form1
    ...
    Sub aturGrid()
        ...
        DataGridView1.Columns(4).HeaderText = "Nomor"
    ...
    Private Sub BtnSimpan_Click(sender As Object, e As EventArgs) Handles BtnSimpan.Click
        ...
        Else
            ...
            If Not RD.HasRows Then
                RD.Close()
                CMD = New MySqlCommand("INSERT INTO tbPeminjaman VALUES (@kode, @nama, @jumlah, @alamat, @nomor, @tanggal, @foto)", CONN)
    ...
    Private Sub DataGridView1_CellClick(sender As Object, e As DataGridViewCellEventArgs) Handles DataGridView1.CellClick
        If DataGridView1.SelectedRows.Count > 0 Then
            ...
            If row.Index < DataGridView1.RowCount - 1 And row.Index >= 0 Then
                ...
                TxtJumlah.Text = row.Cells(2).Value
                TxtAlamat.Text = row.Cells(3).Value
                TxtNomor.Text = row.Cells(4).Value
...
Jumlah = (@jumlah), Alamat = (@alamat), Nomor = (@nomor), Tanggal = (@tanggal), Foto = (@foto) where kode = (@kode)"
